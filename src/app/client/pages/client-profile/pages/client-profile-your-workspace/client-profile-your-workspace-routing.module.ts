...
const routes: Routes = [
	{
		...
		children: [
			...
			},
			{
				...
				loadChildren: () =>
					import(
						'../client-profile-marketplace/client-profile-marketplace.module'
					).then((m) => m.ClientProfileMarketplaceModule),
			},
			{
				...
				loadChildren: () =>
					import(
						'../client-profile-unclaimed-cargo/client-profile-unclaimed-cargo.module'
					).then((m) => m.ClientProfileUnclaimedCargoModule),
			},
		],
	},
];
