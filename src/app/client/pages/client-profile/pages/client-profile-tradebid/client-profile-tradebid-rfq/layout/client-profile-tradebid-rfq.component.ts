...
export class ClientProfileTradebidRfqComponent implements OnInit {
	public totalChatsLength$: Observable<number> =
		this.clientTradeBidService.rfqChatsLength$;
	public totalManageLength$: Observable<number> =
		this.clientTradeBidService.manageListLength$;
	public totalArchivedLength$: Observable<number> =
		this.clientTradeBidService.archivedListLength$;
	...
	ngOnInit(): void {
		this.clientTradeBidService.updateRfqManageList(
			generateQueryString(this.filteredQueryObj)
		);
		this.clientTradeBidService.updateRfqArchivedList(
			generateQueryString(this.filteredQueryObj)
		);
