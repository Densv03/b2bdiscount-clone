...
import { ClientSourcingRequestQuotationFormComponent } from './layout/client-sourcing-request-quotation-form.component';
...
@NgModule({
	...
	// exports: [ClientSourcingRequestQuotationFormComponent],
	imports: [
		CommonModule,
...
export class ClientSourcingRequestQuotationFormModule {}
