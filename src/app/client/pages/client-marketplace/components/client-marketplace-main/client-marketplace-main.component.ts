...
export class ClientMarketplaceMainComponent implements OnInit {
	...
	public onSubmit(): void {
		...
		if (
			this.categoriesState['level1Category'] &&
			!this.categoriesState['level2Category']
		) {
			this.router.navigate(
				['listing', this.categoriesState['level1Category']],
				{
	...
	selectCategory(
		$event: any,
		categoryType: 'level1Category' | 'level2Category'
	) {
