...
export class ClientMarketplaceFiltersMobileComponent implements AfterViewInit, ControlValueAccessor {
	...
	public chooseFilter(option: any, filterIndex: number, hiddenLabel: any, deleteMode: boolean) {
