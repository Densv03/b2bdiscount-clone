...
@UntilDestroy()
@Component({
	selector: 'b2b-client-unclaimed-cargo',
	templateUrl: './client-unclaimed-cargo.component.html',
	styleUrls: ['./client-unclaimed-cargo.component.scss'],
...
export class ClientUnclaimedCargoComponent implements OnInit {
	...
	private addSeoTags() {
		this._seoService.setTitle(
			'Buy Unclaimed cargo and Lost Freight Auction | Globy B2B Marketplace'
		);
		this._seoService.setDescription(
			'Buy and sell unclaimed cargo on our B2B marketplace at a discount of up to 90%. Use your chance to purchase quality goods that have already been delivered to your country'
		);
	}
}
