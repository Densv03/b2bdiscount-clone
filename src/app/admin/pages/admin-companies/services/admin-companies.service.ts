...
export class AdminCompaniesService {
	private adminCompaniesListSource: BehaviorSubject<any> =
		new BehaviorSubject<any>(null);
	private adminCompaniesCountSource: BehaviorSubject<number> =
	...
	public updateAdminCompaniesList(
		paginationModel: PaginationParamsModel,
		otherParams?: any
	): void {
