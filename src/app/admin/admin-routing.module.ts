...
const routes: Routes = [
	{
		...
		children: [
			...
			},
			{
				...
				loadChildren: () =>
					import(
						'../client/pages/client-profile/pages/client-profile-settings/client-profile-settings.module'
			...
			},
			{
				...
				loadChildren: () =>
					import(
						'../client/pages/client-profile/pages/client-profile-add-offer/client-profile-add-offer.module'
			...
			},
			{
				path: 'tradebid',
				loadChildren: () =>
					import('./pages/admin-tradebid/admin-tradebid.module').then(
						(m) => m.AdminTradebidModule
					),
			},
			{
				path: 'b2bmarket',
