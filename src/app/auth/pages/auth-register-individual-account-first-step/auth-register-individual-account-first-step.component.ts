...
export class AuthRegisterIndividualAccountFirstStepComponent implements OnInit {
	...
	public isNextStepDisabled$: Observable<boolean> = this.form.status$.pipe(
	...
	private detectParsingCompanyEmail(): void {
		this.form
			...
			.subscribe(
				({ companyName }: any) => (this.parsingCompanyName = companyName)
			);
	}
	...
	private saveUserData(): void {
		...
		localStorage.setItem(
			BrowserStorageKeysEnum.FIRST_STEP_DATA,
