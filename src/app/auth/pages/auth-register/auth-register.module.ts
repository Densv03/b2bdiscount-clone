...
import { AuthRegisterSupplierCompanyInfoModule } from './components/auth-register-supplier-company-info/auth-register-supplier-company-info.module';
import { AuthRegisterBasicInfoModule } from './components/auth-register-basic-info/auth-register-basic-info.module';
import { MatStepperModule } from '@angular/material/stepper';
import { B2bNgxButtonModule } from '@b2b/ngx-button';
import { B2bNgxIconModule } from '@b2b/ngx-icon';
import { AuthRegisterIndividualAccountModule } from '../auth-register-individual-account/auth-register-individual-account.module';
