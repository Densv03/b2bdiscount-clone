...
/* harmony import */ var _angular_material_dialog__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/material/dialog */ 84334);
...
class AdminBillingService {
    ...
    getQuotesPaymentPlansToDisplay() {
        return this.apiService.get(`authorize-net/get-payment-plan?type=quotes`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)((data) => {
            if (data.length > 3) {
